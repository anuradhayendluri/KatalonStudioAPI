...
WebUI.setText(findTestObject('EsbToken/Page_Sign In/input_ctl00ctl00ctl00BodyConte'), GlobalVariable.ModeratorUser)

WebUI.setText(findTestObject('EsbToken/Page_Sign In/input_ctl00ctl00ctl00BodyConte_1'), GlobalVariable.ModeratorPwd)
...
GlobalVariable.g_ModeratorToken = esbapitoken
...
GlobalVariable.g_NameTemp = userId
GlobalVariable.g_PassTemp=userName
