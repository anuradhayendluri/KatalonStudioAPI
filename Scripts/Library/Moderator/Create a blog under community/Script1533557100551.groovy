...
def request = ((findTestObject('Object Repository/Community/Create blog under community',[('host') : GlobalVariable.g_URL,('communityID') : CommunityID])) as RequestObject)
...
vsRequestBody = vsRequestBody.replace('${blogName}',"\""+blogName+"\"");
vsRequestBody = vsRequestBody.replace('${blogDesc}',"\""+blogDesc+"\"");
