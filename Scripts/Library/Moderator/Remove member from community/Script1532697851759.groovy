...
def request = ((findTestObject('Object Repository/Community/Remove member from community',[('host') : GlobalVariable.g_URL, ('CommunityID') : communityID])) as RequestObject)
