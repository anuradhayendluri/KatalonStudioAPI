...
def request = ((findTestObject('Object Repository/Community/Create discussion under community',[('host') : GlobalVariable.g_URL])) as RequestObject)
...
vsRequestBody = vsRequestBody.replace('${DiscussionDesc}',"\""+DiscussionDesc+"\"");
