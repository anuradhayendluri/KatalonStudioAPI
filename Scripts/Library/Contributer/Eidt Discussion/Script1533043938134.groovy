...
def editResponse = ((findTestObject('Object Repository/Community/Edit Discussion', [('host') : GlobalVariable.g_URL])) as RequestObject)

editResponse.setHttpHeaderProperties(CustomKeywords.'requestHeaders.Headers.AddHeaders'(GlobalVariable.ContributerToken))
