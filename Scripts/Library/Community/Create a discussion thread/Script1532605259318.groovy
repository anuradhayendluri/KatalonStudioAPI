...
def request = ((findTestObject('Object Repository/Community/Create a discussion thread',[('host') : GlobalVariable.g_URL
...
vsRequestBody = vsRequestBody.replace('${Comment}',Comment);
