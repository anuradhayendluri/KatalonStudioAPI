...
ResponseObject response = WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue(
            'CommunityName', 34), ('CommunityDesc') : data.getValue('CommunityDesc', 34), ('allowDiscussionBoards') : true
...
ResponseObject addContributerResponse= WebUI.callTestCase(findTestCase('Library/Community/Add a member to community'), [('rating') : '3', ('userID') : GlobalVariable.ContributerID
	, ('userName') : data.getValue('Contributer', 34), ('communityID') : CommunityID], FailureHandling.STOP_ON_FAILURE)
...
ResponseObject res =WebUI.callTestCase(findTestCase('Library/Moderator/Remove member from community'), [('communityID') : CommunityID, ('userid') : GlobalVariable.ContributerID],
	FailureHandling.STOP_ON_FAILURE)
