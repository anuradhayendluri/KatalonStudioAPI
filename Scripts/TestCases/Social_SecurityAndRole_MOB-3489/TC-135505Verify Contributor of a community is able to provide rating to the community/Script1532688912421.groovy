...
/*ResponseObject response = WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue(
            'CommunityName', 42), ('CommunityDesc') : data.getValue('CommunityDesc', 42), ('allowDiscussionBoards') : true
...
*/
ResponseObject response4= WebUI.callTestCase(findTestCase('Library/Community/Add a member to community'), [('rating') : '3', ('userID') : GlobalVariable.ContributerID
        , ('userName') : GlobalVariable.ContributerUser, ('communityID') : GlobalVariable.CommunityID], FailureHandling.STOP_ON_FAILURE)
WSBuiltInKeywords.verifyResponseStatusCode(response4, 200)
WebUI.callTestCase(findTestCase('Library/Contributer/Create or Update Rating'), [('rating') : '5', ('userID') : GlobalVariable.ContributerID
        , ('communityID') : GlobalVariable.CommunityID], FailureHandling.STOP_ON_FAILURE)

ResponseObject com= WebUI.callTestCase(findTestCase('Library/Community/Get Community details by ID'), [('communityID') : GlobalVariable.CommunityID], FailureHandling.STOP_ON_FAILURE)
