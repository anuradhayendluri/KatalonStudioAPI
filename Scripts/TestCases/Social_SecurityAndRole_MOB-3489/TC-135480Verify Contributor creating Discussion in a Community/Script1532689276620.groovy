...
ResponseObject getAllDis= WebUI.callTestCase(findTestCase('Library/Contributer/Get Discussions'), [('CommunityID') : CommunityID], FailureHandling.STOP_ON_FAILURE)

WSBuiltInKeywords.containsString(getAllDis, data.getValue('DiscussionName', 38), false, FailureHandling.STOP_ON_FAILURE)
