...
/*ResponseObject response = WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue(
            'CommunityName', 37), ('CommunityDesc') : data.getValue('CommunityDesc', 37), ('allowDiscussionBoards') : true
...
WebUI.callTestCase(findTestCase('Library/Community/Create a blog under community'), [('blogName') : data.getValue('BlogName', 
            37), ('blogDesc') : data.getValue('BlogDesc', 37), ('CommunityID') : GlobalVariable.CommunityID], FailureHandling.STOP_ON_FAILURE)

ResponseObject responseBlogs= WebUI.callTestCase(findTestCase('Library/Community/Get Blogs'), [('CommunityID') : GlobalVariable.CommunityID], FailureHandling.STOP_ON_FAILURE)
WS.containsString(responseBlogs, data.getValue('BlogName', 37), false, FailureHandling.STOP_ON_FAILURE)
