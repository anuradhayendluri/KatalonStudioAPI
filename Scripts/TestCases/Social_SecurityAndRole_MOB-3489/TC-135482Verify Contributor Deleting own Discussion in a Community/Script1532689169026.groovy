...
ResponseObject response = WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue(
            'CommunityName', 30), ('CommunityDesc') : data.getValue('CommunityDesc', 30), ('allowDiscussionBoards') : true
...
WebUI.callTestCase(findTestCase('Library/Contributer/Create discussion under community'), [('CommunityID') : CommunityID, ('DiscussionName') : data.getValue("DiscussionName", 30)
        , ('DiscussionDesc') : data.getValue("DiscussionDesc", 30)], FailureHandling.STOP_ON_FAILURE)
...
ResponseObject res= WebUI.callTestCase(findTestCase('Library/Contributer/Delete Discussion Thread'), [('DiscussionID') : finalString], FailureHandling.STOP_ON_FAILURE)
