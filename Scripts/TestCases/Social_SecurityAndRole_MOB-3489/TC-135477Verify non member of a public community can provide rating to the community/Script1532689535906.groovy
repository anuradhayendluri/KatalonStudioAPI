...
ResponseObject response= WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue("CommunityName", 40), ('CommunityDesc') : data.getValue("CommunityDesc", 40), ('allowDiscussionBoards') : true
...
ResponseObject res= WebUI.callTestCase(findTestCase('Library/Moderator/Create or Update Rating'), [('rating') : '4', ('userID') : GlobalVariable.g_NameTemp
        , ('communityID') : CommunityID], FailureHandling.STOP_ON_FAILURE)

WSBuiltInKeywords.verifyResponseStatusCode(res, 200)

ResponseObject com= WebUI.callTestCase(findTestCase('Library/Community/Get Community details by ID'), [('communityID') : CommunityID], FailureHandling.STOP_ON_FAILURE)
