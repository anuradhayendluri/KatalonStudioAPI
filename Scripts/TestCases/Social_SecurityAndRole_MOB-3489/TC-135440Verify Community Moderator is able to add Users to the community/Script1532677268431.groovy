...
ResponseObject response = WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue(
            'CommunityName', 36), ('CommunityDesc') : data.getValue('CommunityDesc', 36), ('allowDiscussionBoards') : true
...
ResponseObject addModeratorResposne= WebUI.callTestCase(findTestCase('Library/Community/Add a member to community'), [('rating') : '2', ('userID') : GlobalVariable.g_NameTemp
        , ('userName') : data.getValue('Contributer', 36), ('communityID') : CommunityID], FailureHandling.STOP_ON_FAILURE)
WSBuiltInKeywords.verifyResponseStatusCode(addModeratorResposne, 200)
ResponseObject addContributerResponse= WebUI.callTestCase(findTestCase('Library/Moderator/Add a member to community'), [('rating') : '2', ('userID') : GlobalVariable.ContributerID, ('userName') : GlobalVariable.ContributerUser
