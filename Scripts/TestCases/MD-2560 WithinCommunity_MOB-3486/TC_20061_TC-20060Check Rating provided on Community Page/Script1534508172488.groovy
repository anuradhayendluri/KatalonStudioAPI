...
ResponseObject response = WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue(
            'CommunityName', 20), ('CommunityDesc') : data.getValue('CommunityDesc', 20), ('allowDiscussionBoards') : true
...
ResponseObject response1 = WebUI.callTestCase(findTestCase('Library/Community/Create or Update Rating'), [('rating') : '1'
        , ('userID') : GlobalVariable.g_UserID, ('communityID') : communityID], FailureHandling.STOP_ON_FAILURE)
