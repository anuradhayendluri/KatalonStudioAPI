...
ResponseObject response= WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue('CommunityName', 21), ('CommunityDesc') : data.getValue('CommunityDesc', 21), ('allowDiscussionBoards') : true
...
WSBuiltInKeywords.verifyElementPropertyValue(response, 'description', data.getValue('CommunityDesc', 21))
WSBuiltInKeywords.verifyElementPropertyValue(response, 'modifiedBy', GlobalVariable.g_UserID)
