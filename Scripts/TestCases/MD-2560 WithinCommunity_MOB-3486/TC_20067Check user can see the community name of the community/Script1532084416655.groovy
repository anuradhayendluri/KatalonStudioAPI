...
ResponseObject response=WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue('CommunityName', 19), ('CommunityDesc') : data.getValue('CommunityDesc', 19), ('allowDiscussionBoards') : true
...
WSBuiltInKeywords.verifyElementPropertyValue(response, 'name', data.getValue('CommunityName', 19))
