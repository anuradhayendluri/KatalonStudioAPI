...
def request = ((findTestObject('Community/Add Rating', [('host') : GlobalVariable.g_URL,('communityID'):GlobalVariable.CommunityID])) as RequestObject)
...
vsRequestBody = vsRequestBody.replace('${communityId}',"\""+GlobalVariable.CommunityID+"\"");
vsRequestBody = vsRequestBody.replace('${ratingNumber}',"4");
...
Boolean value=WSBuiltInKeywords.containsString(response, "4", false)
assert value==true
