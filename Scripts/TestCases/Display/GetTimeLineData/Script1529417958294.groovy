...
reqObj.setRestUrl(GlobalVariable.g_URL+'/Services/api/Common/GetTimeLineData?forceRefresh=true')
def getResponse = WSBuiltInKeywords.sendRequest(reqObj)
WSBuiltInKeywords.verifyResponseStatusCode(getResponse, 200)
WebUI.comment('response text is '+getResponse.getResponseText())
