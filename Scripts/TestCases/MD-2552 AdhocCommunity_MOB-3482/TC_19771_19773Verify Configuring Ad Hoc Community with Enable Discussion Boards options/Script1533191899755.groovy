...
ResponseObject response=WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue('CommunityName', 6), ('CommunityDesc') : data.getValue('CommunityDesc', 6), ('allowDiscussionBoards') : true
...
WSBuiltInKeywords.verifyElementPropertyValue(response, 'name', data.getValue('CommunityName', 6), FailureHandling.STOP_ON_FAILURE)
