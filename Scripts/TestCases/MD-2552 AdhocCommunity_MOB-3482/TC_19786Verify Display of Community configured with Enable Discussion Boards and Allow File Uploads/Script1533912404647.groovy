...
ResponseObject response=WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue('CommunityName', 13), ('CommunityDesc') : data.getValue('CommunityDesc', 13), ('allowDiscussionBoards') : true
        , ('allowBlogPosts') : false, ('allowFileUploads') : true, ('communityCode') : '', ('isPrivate') : false, ('userName') : GlobalVariable.g_userName
...
WSBuiltInKeywords.verifyElementPropertyValue(response, 'name', data.getValue('CommunityName', 13), FailureHandling.STOP_ON_FAILURE)
