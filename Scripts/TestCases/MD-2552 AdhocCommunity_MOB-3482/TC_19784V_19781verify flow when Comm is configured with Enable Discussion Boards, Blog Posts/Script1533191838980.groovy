...
ResponseObject response=WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue('CommunityName', 12), ('CommunityDesc') : data.getValue('CommunityDesc', 12), ('allowDiscussionBoards') : true
...
WSBuiltInKeywords.verifyElementPropertyValue(response, 'name', data.getValue('CommunityName', 12), FailureHandling.STOP_ON_FAILURE)
