...
def data = findTestData('TestData')
 ResponseObject response=WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue('CommunityName', 15), ('CommunityDesc') : data.getValue('CommunityDesc', 15), ('allowDiscussionBoards') : false
...
WSBuiltInKeywords.verifyElementPropertyValue(response, 'name', data.getValue('CommunityName', 15), FailureHandling.STOP_ON_FAILURE)
