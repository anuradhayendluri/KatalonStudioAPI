...
ResponseObject response= WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue('CommunityName', 10), ('CommunityDesc') : data.getValue('CommunityDesc', 10), ('allowDiscussionBoards') : true
        , ('allowBlogPosts') : true, ('allowFileUploads') : false, ('communityCode') : 'code', ('isPrivate') : true, ('userName') : GlobalVariable.g_userName
...
WSBuiltInKeywords.verifyElementPropertyValue(response, 'name', data.getValue('CommunityName', 10), FailureHandling.STOP_ON_FAILURE)
