...
ResponseObject response=WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue('CommunityName', 11), ('CommunityDesc') : data.getValue('CommunityDesc', 11), ('allowDiscussionBoards') : false
...
WSBuiltInKeywords.verifyElementPropertyValue(response, 'name', data.getValue('CommunityName', 11), FailureHandling.STOP_ON_FAILURE)
