...
Object personpk = data.getValue('LMUser', 25)

String pk = ('\'' + personpk) + '\''

Object userid = ''

ResponseObject response = WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : data.getValue('CommunityName', 25), ('CommunityDesc') : data.getValue('CommunityDesc', 25), ('allowDiscussionBoards') : true
...
/*ResponseObject response =WebUI.callTestCase(findTestCase('Library/Community/Create Community'), [('communityName') : '', ('CommunityDesc') : '', ('allowDiscussionBoards') : true
	, ('allowBlogPosts') : true, ('allowFileUploads') : true, ('communityCode') : '', ('isPrivate') : false, ('userName') : ''
	, ('userId') : '', ('role') : '', ('userStatus') : '', ('isHidden') : false, ('disableJoinRequest') : false], FailureHandling.STOP_ON_FAILURE)
*/
...
ResponseObject res5=WebUI.callTestCase(findTestCase('Library/Community/Create or Update Rating'), [('rating') : '3', ('userID') : userid, ('communityID') : communityID], 
    FailureHandling.STOP_ON_FAILURE)
